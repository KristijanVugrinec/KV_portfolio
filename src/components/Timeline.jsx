        ...
        <div className={style.main}>
            ...
            <div className={style.firstYear} ref={firstYearRef}>
                ...
                <div className={style.firstYearText}>
                    <p>Beginning of My Front-End Development Education</p>
                    <p>In 2023, I started my journey into the world of front-end development at Algebra. This education was not just a step towards professional development but also the realization of my dream to create visually appealing and functional websites. From the very beginning, I was motivated to learn the key technologies such as HTML, CSS, and JavaScript, which form the foundation of modern web design and development.
            ...
            <div className={style.secondYear} ref={secondYearRef}>
                <div className={style.secondYearText}>
                    <p>Completion of Education and Skills Acquired</p>
                    <p>
